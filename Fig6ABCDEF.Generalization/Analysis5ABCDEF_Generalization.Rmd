...
INS_mean_male = extract_win_or_pay_mean(dataset_INS_male,dataset_y_male,"WNS_","win",FALSE,FALSE)
BINS_mean_male = extract_win_or_pay_mean(dataset_BINS_male,dataset_y_male,"BNS_","win",FALSE,FALSE)
data2_INS_BINS_invest_male = cbind(INS_mean_male[,c(1,3:ncol(INS_mean_male))],BINS_mean_male[,3:ncol(BINS_mean_male)])

INS_mean_female = extract_win_or_pay_mean(dataset_INS_female,dataset_y_female,"WNS_","win",FALSE,FALSE)
BINS_mean_female = extract_win_or_pay_mean(dataset_BINS_female,dataset_y_female,"BNS_","win",FALSE,FALSE)
...
### AUC
```{r svm_auc_both}
auc_wns_bns = svm_general_auc2(data1_INS_BINS_invest,data2_INS_BINS_invest,cond_col = "#FF7E79",filename = 'general_both_gender_roc_plot.png', ci_span = 0.5)
```
