...
#### Permutation at trial level
```{r svm_perm,eval=FALSE}
acc_gen_perm_trial = svm_perm_trial_general(data1_INS_BINS_invest,dataset_INS,dataset_BINS,dataset_y_attack,1000)
colnames(acc_gen_perm_trial) = "acc_perm"
```
