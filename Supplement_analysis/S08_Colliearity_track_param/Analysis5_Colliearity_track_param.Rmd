...
df_org_ALW_alpha1 = cbind(beh_ALW_alpha1,beh_ALW_alpha2,neural_ALW)
df_org_ALW_alpha2 = cbind(beh_ALW_alpha2,beh_ALW_alpha1,neural_ALW)
...
df_org_AFW_alpha1 = cbind(beh_AFW_alpha1,beh_AFW_alpha2,neural_AFW)
df_org_AFW_alpha2 = cbind(beh_AFW_alpha2,beh_AFW_alpha1,neural_AFW)
...
df_org_DLW_alpha1 = cbind(beh_DLW_alpha1,beh_DLW_alpha2,neural_DLW)
df_org_DLW_alpha2 = cbind(beh_DLW_alpha2,beh_DLW_alpha1,neural_DLW)
...
df_org_DFW_alpha1 = cbind(beh_DFW_alpha1,beh_DFW_alpha2,neural_DFW)
df_org_DFW_alpha2 = cbind(beh_DFW_alpha2,beh_DFW_alpha1,neural_DFW)
...
#Defender-leader
cv_DLW_alpha1 = lm_cv_correlation(df_org_DLW_alpha1,5,100,'r_value'),
cv_DLW_alpha2 = lm_cv_correlation(df_org_DLW_alpha2,5,100,'r_value'),
cv_DLB_beta1 = lm_cv_correlation(df_org_DLB,5,100,'r_value'),

#Defender-follower
cv_DFW_alpha1 = lm_cv_correlation(df_org_DFW_alpha1,5,100,'r_value'),
cv_DFW_alpha2 = lm_cv_correlation(df_org_DFW_alpha2,5,100,'r_value'),
cv_DFB_beta1 = lm_cv_correlation(df_org_DFB,5,100,'r_value')
)
...
#Defender-leader
perm_DLW_alpha1 = lm_perm(df_org_DLW_alpha1,5,5000,'r_value')
perm_DLW_alpha2 = lm_perm(df_org_DLW_alpha2,5,5000,'r_value')
perm_DLB_beta1 = lm_perm(df_org_DLB,5,5000,'r_value')

#Defender-follower
perm_DFW_alpha1 = lm_perm(df_org_DFW_alpha1,5,5000,'r_value')
perm_DFW_alpha2 = lm_perm(df_org_DFW_alpha2,5,5000,'r_value')
perm_DFB_beta1 = lm_perm(df_org_DFB,5,5000,'r_value')
```

### Permutation save
```{r perm_save, eval=FALSE}
#Attacker-leader
saveRDS(perm_ALW_alpha1, "lm_perm_ALW_alpha1_5000_r.RData")
saveRDS(perm_ALW_alpha2, "lm_perm_ALW_alpha2_5000_r.RData")
saveRDS(perm_ALB_beta1, "lm_perm_ALB_beta1_5000_r.RData")

#Attacker-follower
saveRDS(perm_AFW_alpha1, "lm_perm_AFW_alpha1_5000_r.RData")
saveRDS(perm_AFW_alpha2, "lm_perm_AFW_alpha2_5000_r.RData")
saveRDS(perm_AFB_beta1, "lm_perm_AFB_beta1_5000_r.RData")

#Defender-leader
saveRDS(perm_DLW_alpha1, "lm_perm_DLW_alpha1_5000_r.RData")
saveRDS(perm_DLW_alpha2, "lm_perm_DLW_alpha2_5000_r.RData")
saveRDS(perm_DLB_beta1, "lm_perm_DLB_beta1_5000_r.RData")

#Defender-follower
saveRDS(perm_DFW_alpha1, "lm_perm_DFW_alpha1_5000_r.RData")
saveRDS(perm_DFW_alpha2, "lm_perm_DFW_alpha2_5000_r.RData")
saveRDS(perm_DFB_beta1, "lm_perm_DFB_beta1_5000_r.RData")
```

### Permutation read
```{r perm_read}
#Attacker-leader
perm_ALW_alpha1 = readRDS("lm_perm_ALW_alpha1_5000_r.RData")
perm_ALW_alpha2 = readRDS("lm_perm_ALW_alpha2_5000_r.RData")
perm_ALB_beta1 = readRDS("lm_perm_ALB_beta1_5000_r.RData")

#Attacker-follower
perm_AFW_alpha1 = readRDS("lm_perm_AFW_alpha1_5000_r.RData")
perm_AFW_alpha2 = readRDS("lm_perm_AFW_alpha2_5000_r.RData")
perm_AFB_beta1 = readRDS("lm_perm_AFB_beta1_5000_r.RData")

#Defender-leader
perm_DLW_alpha1 = readRDS("lm_perm_DLW_alpha1_5000_r.RData")
perm_DLW_alpha2 = readRDS("lm_perm_DLW_alpha2_5000_r.RData")
perm_DLB_beta1 = readRDS("lm_perm_DLB_beta1_5000_r.RData")

#Defender-follower
perm_DFW_alpha1 = readRDS("lm_perm_DFW_alpha1_5000_r.RData")
perm_DFW_alpha2 = readRDS("lm_perm_DFW_alpha2_5000_r.RData")
perm_DFB_beta1 = readRDS("lm_perm_DFB_beta1_5000_r.RData")
```
