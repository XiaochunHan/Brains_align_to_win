...
cv_list <- list(
#Attacker-leader
control = cbind(beh_ALW_alpha2,beh_ALB)
cv_ALW_alpha1 = lm_cv_correlation(df_org_ALW_alpha1,5,100,TRUE,control),
cv_ALW_alpha2 = lm_cv_correlation(df_org_ALW_alpha2,5,100,TRUE,control_variable = cbind(beh_ALW_alpha1,beh_ALB)),
cv_ALB_beta1 = lm_cv_correlation(df_org_ALB,5,100,TRUE,control_variable = cbind(beh_ALW_alpha1,beh_ALW_alpha2)),

#Attacker-follower
cv_AFW_alpha1 = lm_cv_correlation(df_org_AFW_alpha1,5,100,TRUE,control_variable = cbind(beh_AFW_alpha2,beh_AFB)),
cv_AFW_alpha2 = lm_cv_correlation(df_org_AFW_alpha2,5,100,TRUE,control_variable = cbind(beh_AFW_alpha1,beh_AFB)),
cv_AFB_beta1 = lm_cv_correlation(df_org_AFB,5,100,control_variable = cbind(beh_AFW_alpha1,beh_AFW_alpha2))
)
...
#Attacker-leader
perm_ALW_alpha1 = lm_perm(df_org_ALW_alpha1,5,5000)
perm_ALW_alpha2 = lm_perm(df_org_ALW_alpha2,5,5000)
perm_ALB_beta1 = lm_perm(df_org_ALB,5,5000)

#Attacker-follower
perm_AFW_alpha1 = lm_perm(df_org_AFW_alpha1,5,5000)
perm_AFW_alpha2 = lm_perm(df_org_AFW_alpha2,5,5000)
...
### Fig3C_AFW_alpha2
```{r AFW_fig}
AFW_fig = data.frame(df_org_AFW_alpha2$alpha2, model_list[[5]]$fitted.values)
names(AFW_fig) = c("trueAlpha2", "predictedAlpha2")

p<-ggplot(AFW_fig, aes(x=trueAlpha2, y=predictedAlpha2)) +
  geom_point(color="#946CFF", size = 4, alpha = 0.5) +
  geom_smooth(method=lm , color="#0D0D0D", se=TRUE) +
  theme_classic()
