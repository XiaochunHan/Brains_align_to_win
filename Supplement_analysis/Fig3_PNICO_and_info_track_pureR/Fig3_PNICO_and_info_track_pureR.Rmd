...
cv_list <- list(
#Attacker-leader
cv_ALW_alpha1 = lm_cv_correlation(df_org_ALW_alpha1,5,100),
cv_ALW_alpha2 = lm_cv_correlation(df_org_ALW_alpha2,5,100),
cv_ALB_beta1 = lm_cv_correlation(df_org_ALB,5,100),

#Attacker-follower
cv_AFW_alpha1 = lm_cv_correlation(df_org_AFW_alpha1,5,100),
cv_AFW_alpha2 = lm_cv_correlation(df_org_AFW_alpha2,5,100),
