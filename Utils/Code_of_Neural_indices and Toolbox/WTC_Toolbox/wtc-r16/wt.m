...
%Yang Jiaxin Modified 2018/03/13 
%Main for the Y-axis turn the unit to seconds
%Previous line£º142-146
...
%             'layer','top')
        ...
        yy=num2str(Yticks'*0.021); %Jiaxin Modified _ 0.021 =sample interval
        set(gca,'YLim',log2([min(period),max(period)]), ...
            'YDir','reverse', ...
            'YTick',log2(Yticks(:)), ...
